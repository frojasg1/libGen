...
/*
	protected void changeDefaultCellEditorJTextField()
	{
		try
		{
			FilePane fp = ReflectionFunctions.instance().getAttribute( "filePane", sun.swing.FilePane.class, this, javax.swing.plaf.metal.MetalFileChooserUI.class);
			...
			javassist.CtConstructor cons = javassist.CtNewConstructor.make( " public " + subClass.getSimpleName() + "( sun.swing.FilePane fp, javax.swing.JTextField tf ) \n" +
