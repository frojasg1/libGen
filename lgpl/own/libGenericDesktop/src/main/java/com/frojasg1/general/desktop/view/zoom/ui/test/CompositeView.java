 ...
 */
public abstract class CompositeView extends ViewTest {
    ...
    protected void loadChildren(ViewFactory f) {
        ...
        if (n > 0) {
            javax.swing.text.View[] added = new View[n];
            for (int i = 0; i < n; i++) {
    ...
    public int viewToModel(float x, float y, Shape a, Position.Bias[] bias) {
        ...
        if (isBefore((int) x, (int) y, alloc)) {
            ...
            javax.swing.text.View v = getViewAtPoint((int) x, (int) y, alloc);
            if (v != null) {
     ...
     */
    protected abstract javax.swing.text.View getViewAtPoint(int x, int y, Rectangle alloc);
