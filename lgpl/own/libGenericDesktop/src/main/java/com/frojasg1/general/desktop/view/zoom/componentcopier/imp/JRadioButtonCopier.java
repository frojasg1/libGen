 ...
 */
public class JRadioButtonCopier extends CompCopierBase<JRadioButton>
{

	@Override
	protected List<CompCopier<JRadioButton>> createCopiers() {

		List<CompCopier<JRadioButton>> result = new ArrayList<>();

		return( result );
	}

	@Override
	public Class<JRadioButton> getParameterClass() {
