...
//		setIcon( "com/frojasg1/chesspdfbrowser/resources/icons/App.icon.png" );
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(DesktopSearchAndReplaceWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
//				new DesktopSearchAndReplaceWindow().setVisible(true);
			}
		});
	}
