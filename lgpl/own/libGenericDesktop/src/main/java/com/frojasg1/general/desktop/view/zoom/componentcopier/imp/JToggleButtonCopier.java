 ...
 */
public class JToggleButtonCopier extends CompCopierBase<JToggleButton>
{

	@Override
	protected List<CompCopier<JToggleButton>> createCopiers() {

		List<CompCopier<JToggleButton>> result = new ArrayList<>();

		return( result );
	}

	@Override
	public Class<JToggleButton> getParameterClass() {
