...
//								ViewFunctions.instance().traceComponentTree(rootComponent) );
											...
											double zoomFactor ) throws IllegalAccessException, InstantiationException
	{
		...
		{
			result = (T) ResizableImageJButton.createResizableImageJButton( (JButton) originalComponent );
			if( result != null )
			{
				copyReflection( originalComponent, result );
				( (ResizableImageJButton) result ).resizeImage();
			}
		}
...
*/
	...
	// Object fp is of class: sun.swing.FilePane
...
//			if( hasToSwitchVariables( result ) )
			{
...
*/
	...
	protected boolean hasToSwitchVariables( Component comp )
	{
...
*/
	...
	public Component setZoomFactor( Component rootComponent, double zoomFactor, ComponentFilter compFilter )
	{
...
//					 )
	...
	// function to be called from FileChooser or system dialogs.
	protected void setZoomFactor_internal( Component comp, double zoomFactor, ComponentFilter compFilter )
	{
