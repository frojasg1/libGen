...
import static javax.swing.text.View.ForcedBreakWeight;
...
public class ParagraphView extends FlowView implements TabExpander {
    ...
    public ParagraphView(Element elem) {
        ...
        Object i18nFlag = doc.getProperty( getAbstractDocument_attribute( "I18NProperty" ) );
        if ((i18nFlag != null) && i18nFlag.equals(Boolean.TRUE)) {
            try {
                ...
                if (o instanceof FlowView.FlowStrategy) {
                    strategy = (FlowView.FlowStrategy) o;
                }
            } catch (Throwable e) {
	...
	protected static String getAbstractDocument_attribute( String attributeName )
	{
		return( ReflectionFunctions.instance().getStaticAttribute( attributeName, String.class, AbstractDocument.class ) );
	}
    ...
    protected int getClosestPositionTo(int pos, Position.Bias b, Shape a,
        ...
        for(int vc = 0, numViews = row.getViewCount(); vc < numViews; vc++) {
            ...
            boolean ltr = isLeftToRight( doc, start, start + 1 );
            if(ltr) {
                lastPos = start;
    ...
    protected boolean flipEastAndWestAtEnds(int position,
        ...
        return !isLeftToRight(doc, position, position + 1);
    }

    protected boolean isLeftToRight(Document doc, int p0, int p1) {
        if (Boolean.TRUE.equals(doc.getProperty( getAbstractDocument_attribute( "I18NProperty" ) ))) {
    ...
    class Row extends BoxView {
        ...
        private boolean isJustifiableDocument() {
            return (! Boolean.TRUE.equals(getDocument().getProperty(
                          getAbstractDocument_attribute( "I18NProperty" ) ) ) );
        }
