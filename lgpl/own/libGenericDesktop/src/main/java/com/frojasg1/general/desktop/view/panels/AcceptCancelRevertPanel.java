 ...
 * @author Usuario
 */
public class AcceptCancelRevertPanel extends com.frojasg1.general.desktop.view.panels.CustomJPanel
									implements // ResizableComponentInterface,
												InformerInterface,
												AcceptCancelRevertControllerInterface,
												InternallyMappedComponent
{
	protected static final String _resourcePath = "com/frojasg1/generic/resources/acceptcancel";

	protected AcceptCancelRevertControllerInterface _controller = null;
	 ...
	 */
	public AcceptCancelRevertPanel( AcceptCancelRevertControllerInterface controller )
	{
		init();
	...
	protected MapResizeRelocateComponentItem createResizeRelocateInfo()
	{
		...
		try
		{
			...
			mapRRCI.putResizeRelocateComponentItem(jB_cancel, ResizeRelocateItem.MOVE_LEFT_SIDE_PROPORTIONAL +
																		...
																		ResizeRelocateItem.MOVE_TOP_SIDE_PROPORTIONAL +
																		ResizeRelocateItem.MOVE_BOTTOM_SIDE_PROPORTIONAL );
			mapRRCI.putResizeRelocateComponentItem( jB_revertChanges, ResizeRelocateItem.MOVE_LEFT_SIDE_PROPORTIONAL +
																		ResizeRelocateItem.MOVE_RIGHT_SIDE_PROPORTIONAL +
																		ResizeRelocateItem.MOVE_TOP_SIDE_PROPORTIONAL +
																		ResizeRelocateItem.MOVE_BOTTOM_SIDE_PROPORTIONAL );
/*
			mapRRCI.putResizeRelocateComponentItem( jB_acceptChanges, 0 );
			mapRRCI.putResizeRelocateComponentItem(jB_cancel, 0 );
			mapRRCI.putResizeRelocateComponentItem( jB_revertChanges, 0 );
*/
...
//			HintForComponent hfc3 = new HintForComponent( jB_revertChanges, "Revert changes" );
	...
	public void setRevertButtonEnabled( boolean value )
	{
		jB_revertChanges.setEnabled( value );
	}
	...
	public void setCompoundNameForRevertButton( String name )
	{
		this.jB_revertChanges.setName( name );
	}
	...
	public void setNameForRevertButton( String name )
	{
		ViewFunctions.instance().setNameForComponent( jB_revertChanges, name );
	}
	...
	public String getCompoundNameForRevertButton()
	{
		return( jB_revertChanges.getName() );
	}
    ...
    private void initComponents() {
        ...
        jB_revertChanges = new javax.swing.JButton();
        ...
        jB_cancel.setMaximumSize(new java.awt.Dimension(10000, 10000));
        jB_cancel.setMinimumSize(new java.awt.Dimension(0, 0));
        ...
        jB_acceptChanges.setMaximumSize(new java.awt.Dimension(10000, 10000));
        jB_acceptChanges.setMinimumSize(new java.awt.Dimension(0, 0));
        ...
        jB_revertChanges.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jB_revertChanges.setMaximumSize(new java.awt.Dimension(10000, 10000));
        jB_revertChanges.setMinimumSize(new java.awt.Dimension(0, 0));
        jB_revertChanges.setName("name=jB_revertChanges,icon=com/frojasg1/generic/resources/acceptcancel/revert.png"); // NOI18N
        jB_revertChanges.setPreferredSize(new java.awt.Dimension(30, 30));
        jB_revertChanges.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jB_revertChangesActionPerformed(evt);
            }
        });
        jPanel1.add(jB_revertChanges);
        jB_revertChanges.setBounds(90, 10, 30, 30);

        add(jPanel1);
        jPanel1.setBounds(0, 0, 130, 50);
    ...
    private void jB_revertChangesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_revertChangesActionPerformed
        // TODO add your handling code here:

        revert( this );
    }//GEN-LAST:event_jB_revertChangesActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jB_acceptChanges;
    private javax.swing.JButton jB_cancel;
    private javax.swing.JButton jB_revertChanges;
...
*/
	...
	public void setComponentMapper(ComponentMapper mapper) {
		...
		jB_revertChanges = mapper.mapComponent(jB_revertChanges);
