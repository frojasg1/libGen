 ...
 a rows worth of children in a flow.  This is
    ...
    public static class FlowStrategy {
        ...
        protected View createView(FlowView fv, int startOffset, int spanLeft, int rowIndex) {
			...
			// MODIFICATION
			///////////////////////////////////////////////////////////////////////
			while( ( v.getStartOffset() == v.getEndOffset() ) &&
					( childIndex < lv.getViewCount() ) )
			{
				childIndex++;
				v = lv.getView(childIndex);
			}
			///////////////////////////////////////////////////////////////////////
			// END OF MODIFICATION
			///////////////////////////////////////////////////////////////////////
    ...
    static class LogicalView extends CompositeView {
        ...
        protected void loadChildren(ViewFactory f) {
            Element elem = getElement();
            if (elem.isLeaf()) {
                javax.swing.text.View v = new LabelView(elem);
                append(v);
            } else {
        ...
        protected void forwardUpdate(DocumentEvent.ElementChange ec,
            ...
            if (type == DocumentEvent.EventType.INSERT ||
                ...
                for (int i = firstUpdateIndex; i <= lastUpdateIndex; i++) {
                    ...
                    if (v != null) {
//                        v.updateAfterChange();
						ReflectionFunctions.instance().invokeMethod( "updateAfterChange", v );
                    }
                }
            }
        }
