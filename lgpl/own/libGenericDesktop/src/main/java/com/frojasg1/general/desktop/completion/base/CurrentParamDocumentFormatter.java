 ...
 */
public class CurrentParamDocumentFormatter // extends ZoomDocumentFormatAppender
{
/*
...
//	protected BigMathHelp _bmHelp = null;
	...
	public CurrentParamDocumentFormatter( JTextPane pane,
...
/*
	public void setCurrentParam( PrototypeForCompletion prototype, int index )
	{
		setEmptyString();
	...
	protected void append( PrototypeForCompletion prototype, int index )
	{
		if( prototype != null )
		{
