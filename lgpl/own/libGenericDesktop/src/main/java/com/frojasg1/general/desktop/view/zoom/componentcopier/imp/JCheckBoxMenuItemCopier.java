 ...
 */
public class JCheckBoxMenuItemCopier  extends CompCopierBase<JCheckBoxMenuItem>
{

	@Override
	protected List<CompCopier<JCheckBoxMenuItem>> createCopiers() {

		List<CompCopier<JCheckBoxMenuItem>> result = new ArrayList<>();

		return( result );
	}

	@Override
	public Class<JCheckBoxMenuItem> getParameterClass() {
