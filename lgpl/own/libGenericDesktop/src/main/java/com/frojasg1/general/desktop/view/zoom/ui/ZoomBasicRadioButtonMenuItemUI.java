 ...
 */
public class ZoomBasicRadioButtonMenuItemUI extends BasicRadioButtonMenuItemUI implements MetalComponentWithIconUIforZoomInterface
{
	protected MetalComponentWithIconUIforZoomOverriden _overridenMethods = null;
	protected DoubleReference _zoomFactor = null;

	public ZoomBasicRadioButtonMenuItemUI()
	{
		super();
	}
