 ...
 */
public abstract class GenericDialogToShowBase implements GenericDialogToShowInt
{
	protected ViewComponent _parent = null;

	protected GenericDialogToShowBase()
	{
	}

	protected GenericDialogToShowBase( ViewComponent parent )
	{
		_parent = parent;
	}
