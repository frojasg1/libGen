 ...
 *
 */
package com.frojasg1.general.commandline.application.version;
 ...
 */
public class CommandLineApplicationVersion implements ApplicationVersion
{
	...
	protected static CommandLineApplicationVersion _instance;

	protected String _downloadFile = null;

	public static void changeInstance( CommandLineApplicationVersion inst )
	{
		_instance = inst;
	}

	public static CommandLineApplicationVersion instance()
	{
		if( _instance == null )
			_instance = new CommandLineApplicationVersion();
		return( _instance );
	}
